...
const Nav = ({ setIsOpen, isOpen }) => {
  return (
    <DrawerLayout setIsOpen={setIsOpen} isOpen={isOpen}>
      <div className=" sm:hidden absolute z-50 flex flex-col justify-center lg:inset-y-0  -right-0 lg:right-0 w-64 h-screen lg:mt-3 lg:mr-3 lg:h-[96%] bg-DeepNightBlack shadow-2xl md:rounded-xl md:overflow-hidden">
        <div
        ...
        <div className="flex flex-col gap-y-2 px-6 w-full transition">
          ...
          <NavItem
            setIsOpen={setIsOpen}
            NavRoute={"/Anshu-YadavResume.pdf"}
            NavIcon={<FaDownload />}
            NavText={"Resume"}
          />
        </div>
